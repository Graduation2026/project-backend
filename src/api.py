"""
api.py — FastAPI Controller for the GNN Vulnerability Detection System.
...
Pipeline:
  ...
  5. Runs GNN (GATv2) vulnerability prediction
...
def compile_source(source_path: Path, output_o_path: Path) -> Path:
    ...
    try:
        compiler = "g++" if temp_source_path.suffix.lower() in {".cpp", ".cc", ".cxx"} else "gcc"
